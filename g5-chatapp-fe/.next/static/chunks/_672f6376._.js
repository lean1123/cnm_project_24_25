            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (socket) {
                        ...
                        const receiverId = data.data.contactId === __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"].getState().user?._id ? data.data.userId : data.data.contactId;
...
_s(Layout, "UA8XtdzhpPZuvvQvWTN+N8pFkSo=", false, function() {
    return [
...
//# sourceMappingURL=_672f6376._.js.map
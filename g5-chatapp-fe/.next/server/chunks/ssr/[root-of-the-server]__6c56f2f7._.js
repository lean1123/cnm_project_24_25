...
const VideoCall = ()=>{
    ...
    const [callType, setCallType] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState("video");
    const { isCallActive, isCallAccepted, handleEndCall } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useCallStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallStore"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const appID = parseInt(("TURBOPACK compile-time value", "922999375") || "0");
        if (!appID) {
            throw new Error("NEXT_PUBLIC_ZEGO_APP_ID is not defined or invalid.");
        }
        const serverSecret = ("TURBOPACK compile-time value", "4104c8e96601c2e216fd754c3020e9c3") || "";
        const init = async ()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c56f2f7._.js.map